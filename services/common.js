...
<body style="background-color: #1D4ED8;">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" >
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td align="center" valign="top" style="padding: 36px 24px;">
                            <a href="https://abd-mern-e-commerce.vercel.app" target="_blank"
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin: 0;">Here is a summary of your recent order. If you have any questions or
                                concerns about your order, please <a href="mailto:abdullahsufyan2007@gmail.com">contact
                                    us</a>.</p>
                        </td>
                    </tr>
                    <!-- end copy -->
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td align="left" bgcolor="#1D4ED8" width="60%"
                                        style="padding: 12px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 18px; line-height: 24px; color:#fff;">
                                        <strong>Product Name</strong>
                                    </td>
                                    <td align="left" bgcolor="#1D4ED8" width="20%"
                                        style="padding: 12px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 18px; line-height: 24px; color:#fff;">
                                ...
                                ${order.items.map(
                                  (item) => `<tr>
                                    <td align="left" width="60%"
                                        ...
                                        <div style="display: flex; gap: 0.5rem; align-items: center; justify-content: center; width:100%; height:3.5rem;">
                                        <span> 
                                          <img src="${
                                ...
                                <tr>
                                    <td align="left" width="60%"
                                        style="padding: 12px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 18px; line-height: 24px; border-top: 2px dashed #1D4ED8; border-bottom: 2px dashed #1D4ED8;">
                                        <strong>Total</strong>
                                    </td>
                                    <td align="left" width="20%"
                                        style="padding: 12px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 18px; line-height: 24px; border-top: 2px dashed #1D4ED8; border-bottom: 2px dashed #1D4ED8;">
        ...
        <tr>
            <td align="center" bgcolor="#1D4ED8" valign="top" width="100%">
                <!--[if (gte mso 9)|(IE)]>
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="600">
        <tr>
        <td align="center" valign="top" width="600">
    ...
    order.selectedAddress.pinCode
        ...
        <tr>
            <td align="center" bgcolor="#1D4ED8" style="padding: 24px;">
                <!--[if (gte mso 9)|(IE)]>
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="600">
        <tr>
        <td align="center" valign="top" width="600">
        <![endif]-->
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; ">
                    ...
                    <tr>
                        <td align="center" bgcolor="#1D4ED8"
                            style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #dadada;">
                    ...
                    <tr>
                        <td align="center" bgcolor="#1D4ED8"
                            ...
                            <p style="margin: 0;">To stop receiving these emails, you can <a href="https://sendgrid.com"
                                    target="_blank" style="color:#dadada;">unsubscribe</a> at any time.</p>
...
exports.invoiceTemplateAdmin = function (order, user) {
  return `<!DOCTYPE html>
<html>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" >
        ...
        <![endif]-->
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td align="center" valign="top" style="padding: 36px 24px;">
                            <a href="https://your-ecommerce-website.com" target="_blank"
                                style="display: inline-block;">
                                <img src="./img/paste-logo-light@2x.png" alt="Logo" border="0" width="48"
                                    style="display: block; width: 48px; max-width: 48px; min-width: 48px;">
                            </a>
            ...
            <td align="center" bgcolor="#1D4ED8">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                            <p style="margin: 0;">You have a new order. Below is the summary of the recent order. If there are any questions or
                                concerns, please <a href="mailto:your-email@example.com">contact us</a>.</p>
                        </td>
                    </tr>
                    <!-- End copy -->
                    <!-- Start receipt table -->
